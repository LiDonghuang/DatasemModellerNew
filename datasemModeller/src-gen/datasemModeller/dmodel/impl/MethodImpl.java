 ...
 * <ul>
 *   <li>{@link datasemModeller.dmodel.impl.MethodImpl#getName <em>Name</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.MethodImpl#isFunctionMethod <em>Function Method</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.MethodImpl#getInputs <em>Inputs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodImpl extends MinimalEObjectImpl.Container implements Method
{
  ...
  {
    return DmodelPackage.Literals.METHOD;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.METHOD__NAME, oldName, name));
  }
  ...
  public void setFunctionMethod(boolean newFunctionMethod)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.METHOD__FUNCTION_METHOD, oldFunctionMethod, functionMethod));
  }
  ...
  public EList<String> getInputs()
  {
    if (inputs == null)
    {
      inputs = new EDataTypeEList<String>(String.class, this, DmodelPackage.METHOD__INPUTS);
    }
    return inputs;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DmodelPackage.METHOD__NAME:
        return getName();
      case DmodelPackage.METHOD__FUNCTION_METHOD:
        return isFunctionMethod();
      case DmodelPackage.METHOD__INPUTS:
        return getInputs();
    }

 ...
 * <ul>
 *   <li>{@link datasemModeller.dmodel.impl.PullStrategyImpl#getMechanisms <em>Mechanisms</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PullStrategyImpl extends MinimalEObjectImpl.Container implements PullStrategy
{
  ...
  {
    return DmodelPackage.Literals.PULL_STRATEGY;
  }
  ...
  public EList<Mechanism> getMechanisms()
  {
    if (mechanisms == null)
    {
      mechanisms = new EObjectContainmentEList<Mechanism>(Mechanism.class, this, DmodelPackage.PULL_STRATEGY__MECHANISMS);
    }
    return mechanisms;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DmodelPackage.PULL_STRATEGY__MECHANISMS:

 ...
 * <ul>
 *   <li>{@link datasemModeller.dmodel.impl.DistributionImpl#isIsNormal <em>Is Normal</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.DistributionImpl#isIsUniform <em>Is Uniform</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.DistributionImpl#isIsExponential <em>Is Exponential</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.DistributionImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DistributionImpl extends MinimalEObjectImpl.Container implements Distribution
{
  ...
  {
    return DmodelPackage.Literals.DISTRIBUTION;
  }
  ...
  public void setIsNormal(boolean newIsNormal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.DISTRIBUTION__IS_NORMAL, oldIsNormal, isNormal));
  }
  ...
  public void setIsUniform(boolean newIsUniform)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.DISTRIBUTION__IS_UNIFORM, oldIsUniform, isUniform));
  }
  ...
  public void setIsExponential(boolean newIsExponential)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.DISTRIBUTION__IS_EXPONENTIAL, oldIsExponential, isExponential));
  }
  ...
  public EList<String> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EDataTypeEList<String>(String.class, this, DmodelPackage.DISTRIBUTION__PARAMETERS);
    }
    return parameters;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DmodelPackage.DISTRIBUTION__IS_NORMAL:
        return isIsNormal();
      case DmodelPackage.DISTRIBUTION__IS_UNIFORM:
        return isIsUniform();
      case DmodelPackage.DISTRIBUTION__IS_EXPONENTIAL:
        return isIsExponential();
      case DmodelPackage.DISTRIBUTION__PARAMETERS:

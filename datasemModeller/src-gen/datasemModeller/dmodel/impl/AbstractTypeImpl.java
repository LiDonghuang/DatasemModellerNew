 ...
 * <ul>
 *   <li>{@link datasemModeller.dmodel.impl.AbstractTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.AbstractTypeImpl#isListType <em>List Type</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.AbstractTypeImpl#isMapType <em>Map Type</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.AbstractTypeImpl#getKeyType <em>Key Type</em>}</li>
 *   <li>{@link datasemModeller.dmodel.impl.AbstractTypeImpl#getValueType <em>Value Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractTypeImpl extends MinimalEObjectImpl.Container implements AbstractType
{
  ...
  {
    return DmodelPackage.Literals.ABSTRACT_TYPE;
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.ABSTRACT_TYPE__TYPE, oldType, type));
  }
  ...
  public void setListType(boolean newListType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.ABSTRACT_TYPE__LIST_TYPE, oldListType, listType));
  }
  ...
  public void setMapType(boolean newMapType)
  {
    ...
    mapType = newMapType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.ABSTRACT_TYPE__MAP_TYPE, oldMapType, mapType));
  }
  ...
  public void setKeyType(String newKeyType)
  {
    ...
    keyType = newKeyType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.ABSTRACT_TYPE__KEY_TYPE, oldKeyType, keyType));
  }
  ...
  public void setValueType(String newValueType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DmodelPackage.ABSTRACT_TYPE__VALUE_TYPE, oldValueType, valueType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DmodelPackage.ABSTRACT_TYPE__TYPE:
        return getType();
      case DmodelPackage.ABSTRACT_TYPE__LIST_TYPE:
        return isListType();
      case DmodelPackage.ABSTRACT_TYPE__MAP_TYPE:
        return isMapType();
      case DmodelPackage.ABSTRACT_TYPE__KEY_TYPE:
        return getKeyType();
      case DmodelPackage.ABSTRACT_TYPE__VALUE_TYPE:
        return getValueType();
    }

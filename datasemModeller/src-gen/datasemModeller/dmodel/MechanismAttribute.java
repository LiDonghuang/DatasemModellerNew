 ...
 * <ul>
 *   <li>{@link datasemModeller.dmodel.MechanismAttribute#getName <em>Name</em>}</li>
...
public interface MechanismAttribute extends EObject
{
   ...
   * @see #setName(String)
   * @see datasemModeller.dmodel.DmodelPackage#getMechanismAttribute_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link datasemModeller.dmodel.MechanismAttribute#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

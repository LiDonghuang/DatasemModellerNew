 ...
 *   <li>{@link datasemModeller.dmodel.ServiceProviderType#getDescription <em>Description</em>}</li>
...
public interface ServiceProviderType extends EObject
{
   ...
   * @see datasemModeller.dmodel.DmodelPackage#getServiceProviderType_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link datasemModeller.dmodel.ServiceProviderType#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getServiceProviderAccess().getGroup_9_4(), "rule__ServiceProvider__Group_9_4__0");
					...
					put(grammarAccess.getWorkSourceAccess().getAssignmentRuleAssignment_4(), "rule__WorkSource__AssignmentRuleAssignment_4");
					...
					put(grammarAccess.getWorkItemAccess().getCOSAssignment_12_1(), "rule__WorkItem__COSAssignment_12_1");
					put(grammarAccess.getWorkItemAccess().getWItemSourceAssignment_13_1(), "rule__WorkItem__WItemSourceAssignment_13_1");
					put(grammarAccess.getWorkItemAccess().getArrtimeAssignment_14_1(), "rule__WorkItem__ArrtimeAssignment_14_1");
					...
					put(grammarAccess.getServiceProviderAccess().getResourcesAssignment_7_2(), "rule__ServiceProvider__ResourcesAssignment_7_2");
					put(grammarAccess.getServiceProviderAccess().getServicesAssignment_8_2(), "rule__ServiceProvider__ServicesAssignment_8_2");
					put(grammarAccess.getServiceProviderAccess().getDefaultStrategyAssignment_9_3(), "rule__ServiceProvider__DefaultStrategyAssignment_9_3");
					put(grammarAccess.getServiceProviderAccess().getAcceptanceRuleAssignment_9_4_2(), "rule__ServiceProvider__AcceptanceRuleAssignment_9_4_2");
					put(grammarAccess.getServiceProviderAccess().getSelectionRuleAssignment_9_4_3(), "rule__ServiceProvider__SelectionRuleAssignment_9_4_3");
					put(grammarAccess.getServiceProviderAccess().getAssignmentRuleAssignment_9_4_4(), "rule__ServiceProvider__AssignmentRuleAssignment_9_4_4");
					put(grammarAccess.getServiceProviderAccess().getAllocationRuleAssignment_9_4_5(), "rule__ServiceProvider__AllocationRuleAssignment_9_4_5");
					put(grammarAccess.getServiceProviderAccess().getOutsourcingRuleAssignment_9_4_6(), "rule__ServiceProvider__OutsourcingRuleAssignment_9_4_6");

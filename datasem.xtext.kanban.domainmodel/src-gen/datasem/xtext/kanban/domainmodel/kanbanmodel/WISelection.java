 ...
 * <ul>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.WISelection#getName <em>Name</em>}</li>
...
public interface WISelection extends EObject
{
   ...
   * @see #setName(String)
   * @see datasem.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getWISelection_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link datasem.xtext.kanban.domainmodel.kanbanmodel.WISelection#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

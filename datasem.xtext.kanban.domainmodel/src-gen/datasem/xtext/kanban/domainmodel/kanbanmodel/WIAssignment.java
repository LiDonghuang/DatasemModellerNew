 ...
 * <ul>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.WIAssignment#getName <em>Name</em>}</li>
...
public interface WIAssignment extends EObject
{
   ...
   * @see #setName(String)
   * @see datasem.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getWIAssignment_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link datasem.xtext.kanban.domainmodel.kanbanmodel.WIAssignment#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

 ...
 * <ul>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.PushStrategyImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.PushStrategyImpl#getMechanisms <em>Mechanisms</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.PushStrategyImpl#getProcesses <em>Processes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PushStrategyImpl extends MinimalEObjectImpl.Container implements PushStrategy
{
  ...
  {
    return KanbanmodelPackage.Literals.PUSH_STRATEGY;
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.PUSH_STRATEGY__DESCRIPTION, oldDescription, description));
  }
  ...
  public EList<Mechanism> getMechanisms()
  {
    if (mechanisms == null)
    {
      mechanisms = new EObjectContainmentEList<Mechanism>(Mechanism.class, this, KanbanmodelPackage.PUSH_STRATEGY__MECHANISMS);
    }
    return mechanisms;
  }
  ...
  public EList<ProcessModel> getProcesses()
  {
    if (processes == null)
    {
      processes = new EObjectResolvingEList<ProcessModel>(ProcessModel.class, this, KanbanmodelPackage.PUSH_STRATEGY__PROCESSES);
    }
    return processes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KanbanmodelPackage.PUSH_STRATEGY__MECHANISMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KanbanmodelPackage.PUSH_STRATEGY__DESCRIPTION:
        return getDescription();
      case KanbanmodelPackage.PUSH_STRATEGY__MECHANISMS:
        return getMechanisms();
      case KanbanmodelPackage.PUSH_STRATEGY__PROCESSES:
        return getProcesses();
    }

...
import datasem.xtext.kanban.domainmodel.kanbanmodel.DeclarationStatement;
import datasem.xtext.kanban.domainmodel.kanbanmodel.ForExpression;
import datasem.xtext.kanban.domainmodel.kanbanmodel.IfExpression;
import datasem.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage;
import datasem.xtext.kanban.domainmodel.kanbanmodel.Statement;
import datasem.xtext.kanban.domainmodel.kanbanmodel.WhileExpression;
 ...
 * <ul>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#isIsAction <em>Is Action</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#getActionStatement <em>Action Statement</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#isIsChangeState <em>Is Change State</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#getChangeStateStatement <em>Change State Statement</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#isIsDeclaration <em>Is Declaration</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#getDeclarationStatement <em>Declaration Statement</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#isIsIfExpression <em>Is If Expression</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#getIfExpression <em>If Expression</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#isIsForExpression <em>Is For Expression</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#getForExpression <em>For Expression</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#isIsWhileExpression <em>Is While Expression</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#getWhileExpression <em>While Expression</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.StatementImpl#getAssertStatement <em>Assert Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatementImpl extends MinimalEObjectImpl.Container implements Statement
{
  ...
  {
    return KanbanmodelPackage.Literals.STATEMENT;
  }
  ...
  public void setIsAction(boolean newIsAction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IS_ACTION, oldIsAction, isAction));
  }
  ...
  public NotificationChain basicSetActionStatement(ActionStatement newActionStatement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__ACTION_STATEMENT, oldActionStatement, newActionStatement);
  ...
  public void setActionStatement(ActionStatement newActionStatement)
  {
    if (newActionStatement != actionStatement)
    {
      ...
      if (actionStatement != null)
        msgs = ((InternalEObject)actionStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__ACTION_STATEMENT, null, msgs);
      if (newActionStatement != null)
        msgs = ((InternalEObject)newActionStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__ACTION_STATEMENT, null, msgs);
      msgs = basicSetActionStatement(newActionStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__ACTION_STATEMENT, newActionStatement, newActionStatement));
  }
  ...
  public void setIsChangeState(boolean newIsChangeState)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IS_CHANGE_STATE, oldIsChangeState, isChangeState));
  }
  ...
  public NotificationChain basicSetChangeStateStatement(ChangeStateStatement newChangeStateStatement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__CHANGE_STATE_STATEMENT, oldChangeStateStatement, newChangeStateStatement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setChangeStateStatement(ChangeStateStatement newChangeStateStatement)
  {
    if (newChangeStateStatement != changeStateStatement)
    {
      ...
      if (changeStateStatement != null)
        msgs = ((InternalEObject)changeStateStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__CHANGE_STATE_STATEMENT, null, msgs);
      if (newChangeStateStatement != null)
        msgs = ((InternalEObject)newChangeStateStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__CHANGE_STATE_STATEMENT, null, msgs);
      msgs = basicSetChangeStateStatement(newChangeStateStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__CHANGE_STATE_STATEMENT, newChangeStateStatement, newChangeStateStatement));
  }
  ...
  public void setIsDeclaration(boolean newIsDeclaration)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IS_DECLARATION, oldIsDeclaration, isDeclaration));
  }
  ...
  public NotificationChain basicSetDeclarationStatement(DeclarationStatement newDeclarationStatement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__DECLARATION_STATEMENT, oldDeclarationStatement, newDeclarationStatement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDeclarationStatement(DeclarationStatement newDeclarationStatement)
  {
    if (newDeclarationStatement != declarationStatement)
    {
      ...
      if (declarationStatement != null)
        msgs = ((InternalEObject)declarationStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__DECLARATION_STATEMENT, null, msgs);
      if (newDeclarationStatement != null)
        msgs = ((InternalEObject)newDeclarationStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__DECLARATION_STATEMENT, null, msgs);
      msgs = basicSetDeclarationStatement(newDeclarationStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__DECLARATION_STATEMENT, newDeclarationStatement, newDeclarationStatement));
  }
  ...
  public void setIsIfExpression(boolean newIsIfExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IS_IF_EXPRESSION, oldIsIfExpression, isIfExpression));
  }
  ...
  public NotificationChain basicSetIfExpression(IfExpression newIfExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IF_EXPRESSION, oldIfExpression, newIfExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setIfExpression(IfExpression newIfExpression)
  {
    if (newIfExpression != ifExpression)
    {
      ...
      if (ifExpression != null)
        msgs = ((InternalEObject)ifExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__IF_EXPRESSION, null, msgs);
      if (newIfExpression != null)
        msgs = ((InternalEObject)newIfExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__IF_EXPRESSION, null, msgs);
      msgs = basicSetIfExpression(newIfExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IF_EXPRESSION, newIfExpression, newIfExpression));
  }
  ...
  public void setIsForExpression(boolean newIsForExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IS_FOR_EXPRESSION, oldIsForExpression, isForExpression));
  }
  ...
  public NotificationChain basicSetForExpression(ForExpression newForExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__FOR_EXPRESSION, oldForExpression, newForExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setForExpression(ForExpression newForExpression)
  {
    if (newForExpression != forExpression)
    {
      ...
      if (forExpression != null)
        msgs = ((InternalEObject)forExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__FOR_EXPRESSION, null, msgs);
      if (newForExpression != null)
        msgs = ((InternalEObject)newForExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__FOR_EXPRESSION, null, msgs);
      msgs = basicSetForExpression(newForExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__FOR_EXPRESSION, newForExpression, newForExpression));
  }
  ...
  public void setIsWhileExpression(boolean newIsWhileExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__IS_WHILE_EXPRESSION, oldIsWhileExpression, isWhileExpression));
  }
  ...
  public NotificationChain basicSetWhileExpression(WhileExpression newWhileExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__WHILE_EXPRESSION, oldWhileExpression, newWhileExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setWhileExpression(WhileExpression newWhileExpression)
  {
    if (newWhileExpression != whileExpression)
    {
      ...
      if (whileExpression != null)
        msgs = ((InternalEObject)whileExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__WHILE_EXPRESSION, null, msgs);
      if (newWhileExpression != null)
        msgs = ((InternalEObject)newWhileExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__WHILE_EXPRESSION, null, msgs);
      msgs = basicSetWhileExpression(newWhileExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__WHILE_EXPRESSION, newWhileExpression, newWhileExpression));
  }
  ...
  public NotificationChain basicSetAssertStatement(AssertStatement newAssertStatement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__ASSERT_STATEMENT, oldAssertStatement, newAssertStatement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAssertStatement(AssertStatement newAssertStatement)
  {
    if (newAssertStatement != assertStatement)
    {
      ...
      if (assertStatement != null)
        msgs = ((InternalEObject)assertStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__ASSERT_STATEMENT, null, msgs);
      if (newAssertStatement != null)
        msgs = ((InternalEObject)newAssertStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KanbanmodelPackage.STATEMENT__ASSERT_STATEMENT, null, msgs);
      msgs = basicSetAssertStatement(newAssertStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.STATEMENT__ASSERT_STATEMENT, newAssertStatement, newAssertStatement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KanbanmodelPackage.STATEMENT__ACTION_STATEMENT:
        return basicSetActionStatement(null, msgs);
      case KanbanmodelPackage.STATEMENT__CHANGE_STATE_STATEMENT:
        return basicSetChangeStateStatement(null, msgs);
      case KanbanmodelPackage.STATEMENT__DECLARATION_STATEMENT:
        return basicSetDeclarationStatement(null, msgs);
      case KanbanmodelPackage.STATEMENT__IF_EXPRESSION:
        return basicSetIfExpression(null, msgs);
      case KanbanmodelPackage.STATEMENT__FOR_EXPRESSION:
        return basicSetForExpression(null, msgs);
      case KanbanmodelPackage.STATEMENT__WHILE_EXPRESSION:
        return basicSetWhileExpression(null, msgs);
      case KanbanmodelPackage.STATEMENT__ASSERT_STATEMENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KanbanmodelPackage.STATEMENT__IS_ACTION:
        return isIsAction();
      case KanbanmodelPackage.STATEMENT__ACTION_STATEMENT:
        return getActionStatement();
      case KanbanmodelPackage.STATEMENT__IS_CHANGE_STATE:
        return isIsChangeState();
      case KanbanmodelPackage.STATEMENT__CHANGE_STATE_STATEMENT:
        return getChangeStateStatement();
      case KanbanmodelPackage.STATEMENT__IS_DECLARATION:
        return isIsDeclaration();
      case KanbanmodelPackage.STATEMENT__DECLARATION_STATEMENT:
        return getDeclarationStatement();
      case KanbanmodelPackage.STATEMENT__IS_IF_EXPRESSION:
        return isIsIfExpression();
      case KanbanmodelPackage.STATEMENT__IF_EXPRESSION:
        return getIfExpression();
      case KanbanmodelPackage.STATEMENT__IS_FOR_EXPRESSION:
        return isIsForExpression();
      case KanbanmodelPackage.STATEMENT__FOR_EXPRESSION:
        return getForExpression();
      case KanbanmodelPackage.STATEMENT__IS_WHILE_EXPRESSION:

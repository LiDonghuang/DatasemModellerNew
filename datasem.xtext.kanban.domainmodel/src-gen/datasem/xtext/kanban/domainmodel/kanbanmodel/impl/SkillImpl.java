 ...
 * <ul>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.SkillImpl#getName <em>Name</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.impl.SkillImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SkillImpl extends MinimalEObjectImpl.Container implements Skill
{
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.SKILL__DESCRIPTION, oldDescription, description));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KanbanmodelPackage.SKILL__NAME:
        return getName();
      case KanbanmodelPackage.SKILL__DESCRIPTION:

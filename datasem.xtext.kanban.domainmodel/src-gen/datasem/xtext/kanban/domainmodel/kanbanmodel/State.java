 ...
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.State#getActions <em>Actions</em>}</li>
 *   <li>{@link datasem.xtext.kanban.domainmodel.kanbanmodel.State#getTransitions <em>Transitions</em>}</li>
 * </ul>
 * </p>
 *
...
public interface State extends EObject
{
   ...
   * @see datasem.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getState_Actions()
   * @model
   * @generated
   */
   ...
   * @see datasem.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getState_Transitions()

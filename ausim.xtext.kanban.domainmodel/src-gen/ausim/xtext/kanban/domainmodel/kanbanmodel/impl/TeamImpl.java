 ...
 *   <li>{@link ausim.xtext.kanban.domainmodel.kanbanmodel.impl.TeamImpl#getDescription <em>Description</em>}</li>
...
public class TeamImpl extends MinimalEObjectImpl.Container implements Team
{
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KanbanmodelPackage.TEAM__DESCRIPTION, oldDescription, description));
  }
  ...
  public EList<Service> getServices()
  {
    if (services == null)
    {
      services = new EObjectResolvingEList<Service>(Service.class, this, KanbanmodelPackage.TEAM__SERVICES);
    }
    return services;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KanbanmodelPackage.TEAM__NAME:
        return getName();
      case KanbanmodelPackage.TEAM__DESCRIPTION:

		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGovernanceStrategyAccess().getAlternatives_2(), "rule__GovernanceStrategy__Alternatives_2");
					...
					put(grammarAccess.getGovernanceStrategyAccess().getGroup_2_0(), "rule__GovernanceStrategy__Group_2_0__0");
					put(grammarAccess.getGovernanceStrategyAccess().getGroup_2_0_2(), "rule__GovernanceStrategy__Group_2_0_2__0");
					put(grammarAccess.getGovernanceStrategyAccess().getGroup_2_1(), "rule__GovernanceStrategy__Group_2_1__0");
					put(grammarAccess.getGovernanceStrategyAccess().getGroup_2_1_2(), "rule__GovernanceStrategy__Group_2_1_2__0");
					put(grammarAccess.getGovernanceStrategyAccess().getGroup_2_2(), "rule__GovernanceStrategy__Group_2_2__0");
					put(grammarAccess.getGovernanceStrategyAccess().getGroup_2_2_2(), "rule__GovernanceStrategy__Group_2_2_2__0");
					...
					put(grammarAccess.getWorkItemAccess().getGroup_6_3(), "rule__WorkItem__Group_6_3__0");
					...
					put(grammarAccess.getGovernanceStrategyAccess().getPullAssignment_2_0_0(), "rule__GovernanceStrategy__PullAssignment_2_0_0");
					put(grammarAccess.getGovernanceStrategyAccess().getDescriptionAssignment_2_0_2_1(), "rule__GovernanceStrategy__DescriptionAssignment_2_0_2_1");
					put(grammarAccess.getGovernanceStrategyAccess().getPullStrategyAssignment_2_0_3(), "rule__GovernanceStrategy__PullStrategyAssignment_2_0_3");
					put(grammarAccess.getGovernanceStrategyAccess().getPushAssignment_2_1_0(), "rule__GovernanceStrategy__PushAssignment_2_1_0");
					put(grammarAccess.getGovernanceStrategyAccess().getDescriptionAssignment_2_1_2_1(), "rule__GovernanceStrategy__DescriptionAssignment_2_1_2_1");
					put(grammarAccess.getGovernanceStrategyAccess().getPushStrategyAssignment_2_1_3(), "rule__GovernanceStrategy__PushStrategyAssignment_2_1_3");
					put(grammarAccess.getGovernanceStrategyAccess().getCnpAssignment_2_2_0(), "rule__GovernanceStrategy__CnpAssignment_2_2_0");
					put(grammarAccess.getGovernanceStrategyAccess().getDescriptionAssignment_2_2_2_1(), "rule__GovernanceStrategy__DescriptionAssignment_2_2_2_1");
					put(grammarAccess.getGovernanceStrategyAccess().getContractNetProtocalAssignment_2_2_3(), "rule__GovernanceStrategy__ContractNetProtocalAssignment_2_2_3");
					put(grammarAccess.getGovernanceStrategyAccess().getProcessesAssignment_5(), "rule__GovernanceStrategy__ProcessesAssignment_5");
					put(grammarAccess.getContractNetProtocolAccess().getVariablesAssignment_0(), "rule__ContractNetProtocol__VariablesAssignment_0");
					put(grammarAccess.getContractNetProtocolAccess().getRoleBehaviorsAssignment_3(), "rule__ContractNetProtocol__RoleBehaviorsAssignment_3");
					...
					put(grammarAccess.getWorkItemAccess().getHasImpactsAssignment_6_0(), "rule__WorkItem__HasImpactsAssignment_6_0");
					put(grammarAccess.getWorkItemAccess().getImpactsAssignment_6_2(), "rule__WorkItem__ImpactsAssignment_6_2");
					put(grammarAccess.getWorkItemAccess().getImpactsAssignment_6_3_1(), "rule__WorkItem__ImpactsAssignment_6_3_1");
					put(grammarAccess.getWorkItemAccess().getValueAssignment_7_1(), "rule__WorkItem__ValueAssignment_7_1");
					put(grammarAccess.getWorkItemAccess().getIdAssignment_9(), "rule__WorkItem__IdAssignment_9");

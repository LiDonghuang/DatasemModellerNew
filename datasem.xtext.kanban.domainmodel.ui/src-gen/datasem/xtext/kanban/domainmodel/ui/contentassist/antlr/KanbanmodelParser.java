		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getWorkItemAccess().getValueAssignment_15_1(), "rule__WorkItem__ValueAssignment_15_1");
					put(grammarAccess.getWorkItemAccess().getClassOfServiceAssignment_16_1(), "rule__WorkItem__ClassOfServiceAssignment_16_1");
					put(grammarAccess.getWorkItemAccess().getWorkSourceAssignment_17_1(), "rule__WorkItem__WorkSourceAssignment_17_1");
					put(grammarAccess.getWorkItemAccess().getArrivalTimeAssignment_18_1(), "rule__WorkItem__ArrivalTimeAssignment_18_1");
					put(grammarAccess.getWorkItemAccess().getDueDateAssignment_19_1(), "rule__WorkItem__DueDateAssignment_19_1");

		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getKanbanSchedulingSystemAccess().getGroup_3(), "rule__KanbanSchedulingSystem__Group_3__0");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getGroup_6(), "rule__KanbanSchedulingSystem__Group_6__0");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getGroup_7(), "rule__KanbanSchedulingSystem__Group_7__0");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getGroup_8(), "rule__KanbanSchedulingSystem__Group_8__0");
					...
					put(grammarAccess.getKanbanSchedulingSystemAccess().getKSSRepositoriesAssignment_3_1(), "rule__KanbanSchedulingSystem__KSSRepositoriesAssignment_3_1");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getMechanismsAssignment_5(), "rule__KanbanSchedulingSystem__MechanismsAssignment_5");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getKSSSearchStrategiesAssignment_6_1(), "rule__KanbanSchedulingSystem__KSSSearchStrategiesAssignment_6_1");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getKSSTaskPatternsAssignment_7_1(), "rule__KanbanSchedulingSystem__KSSTaskPatternsAssignment_7_1");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getKSStaskPatternTypesAssignment_7_2(), "rule__KanbanSchedulingSystem__KSStaskPatternTypesAssignment_7_2");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getKSSValueFunctionsAssignment_8_1(), "rule__KanbanSchedulingSystem__KSSValueFunctionsAssignment_8_1");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getSoSServicesAssignment_12(), "rule__KanbanSchedulingSystem__SoSServicesAssignment_12");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getOrgUnitsAssignment_15(), "rule__KanbanSchedulingSystem__OrgUnitsAssignment_15");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getKssSourcesAssignment_20(), "rule__KanbanSchedulingSystem__KssSourcesAssignment_20");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getKssWItemsAssignment_23(), "rule__KanbanSchedulingSystem__KssWItemsAssignment_23");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getReplicationsAssignment_28(), "rule__KanbanSchedulingSystem__ReplicationsAssignment_28");
					put(grammarAccess.getKanbanSchedulingSystemAccess().getInterArrivalTimeAssignment_30(), "rule__KanbanSchedulingSystem__InterArrivalTimeAssignment_30");
					...
					put(grammarAccess.getWorkItemProfileAccess().getRefTasksAssignment_4_2(), "rule__WorkItemProfile__RefTasksAssignment_4_2");
					put(grammarAccess.getWorkItemProfileAccess().getDecTasksAssignment_5_2(), "rule__WorkItemProfile__DecTasksAssignment_5_2");
					put(grammarAccess.getWorkItemProfileAccess().getReqSpecialtiesAssignment_6_1(), "rule__WorkItemProfile__ReqSpecialtiesAssignment_6_1");
					put(grammarAccess.getWorkItemProfileAccess().getBeffortsAssignment_7_1(), "rule__WorkItemProfile__BeffortsAssignment_7_1");
					put(grammarAccess.getWorkItemProfileAccess().getBvalueAssignment_8_1(), "rule__WorkItemProfile__BvalueAssignment_8_1");
					put(grammarAccess.getWorkItemProfileAccess().getCOSAssignment_9_1(), "rule__WorkItemProfile__COSAssignment_9_1");
					put(grammarAccess.getWorkReferenceAccess().getWorkItemAssignment_1(), "rule__WorkReference__WorkItemAssignment_1");
					put(grammarAccess.getWorkReferenceAccess().getAmountAssignment_3(), "rule__WorkReference__AmountAssignment_3");
					put(grammarAccess.getWorkDecompositionAccess().getWorkItemAssignment_1(), "rule__WorkDecomposition__WorkItemAssignment_1");
					put(grammarAccess.getWorkDecompositionAccess().getAmountAssignment_3(), "rule__WorkDecomposition__AmountAssignment_3");
					...
					put(grammarAccess.getWorkItemAccess().getReqSpecialtiesAssignment_10_1(), "rule__WorkItem__ReqSpecialtiesAssignment_10_1");
					put(grammarAccess.getWorkItemAccess().getBeffortsAssignment_11_1(), "rule__WorkItem__BeffortsAssignment_11_1");
					put(grammarAccess.getWorkItemAccess().getBvalueAssignment_12_1(), "rule__WorkItem__BvalueAssignment_12_1");
					put(grammarAccess.getWorkItemAccess().getLvalueAssignment_13_1(), "rule__WorkItem__LvalueAssignment_13_1");
					put(grammarAccess.getWorkItemAccess().getCOSAssignment_14_1(), "rule__WorkItem__COSAssignment_14_1");
					put(grammarAccess.getWorkItemAccess().getWItemSourceAssignment_15_1(), "rule__WorkItem__WItemSourceAssignment_15_1");
					put(grammarAccess.getWorkItemAccess().getArrtimeAssignment_16_1(), "rule__WorkItem__ArrtimeAssignment_16_1");
					put(grammarAccess.getWorkItemAccess().getDuedateAssignment_17_1(), "rule__WorkItem__DuedateAssignment_17_1");

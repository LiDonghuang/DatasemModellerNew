		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExperimentVariableAccess().getAlternatives_3(), "rule__ExperimentVariable__Alternatives_3");
					...
					put(grammarAccess.getExperimentVariableAccess().getGroup_3_0(), "rule__ExperimentVariable__Group_3_0__0");
					put(grammarAccess.getExperimentVariableAccess().getGroup_3_1(), "rule__ExperimentVariable__Group_3_1__0");
					put(grammarAccess.getExperimentVariableAccess().getGroup_3_2(), "rule__ExperimentVariable__Group_3_2__0");
					put(grammarAccess.getExperimentVariableAccess().getGroup_3_3(), "rule__ExperimentVariable__Group_3_3__0");
					put(grammarAccess.getExperimentVariableAccess().getGroup_3_4(), "rule__ExperimentVariable__Group_3_4__0");
					...
					put(grammarAccess.getContractNetProtocolAccess().getGroup_0(), "rule__ContractNetProtocol__Group_0__0");
					...
					put(grammarAccess.getPullStrategyAccess().getGroup_0(), "rule__PullStrategy__Group_0__0");
					put(grammarAccess.getPushStrategyAccess().getGroup(), "rule__PushStrategy__Group__0");
					put(grammarAccess.getPushStrategyAccess().getGroup_0(), "rule__PushStrategy__Group_0__0");
					...
					put(grammarAccess.getWorkItemAccess().getGroup_5_1_0_3(), "rule__WorkItem__Group_5_1_0_3__0");
					put(grammarAccess.getWorkItemAccess().getGroup_5_1_4(), "rule__WorkItem__Group_5_1_4__0");
					...
					put(grammarAccess.getUserLibrariesAccess().getProcessModelsAssignment_8(), "rule__UserLibraries__ProcessModelsAssignment_8");
					put(grammarAccess.getUserLibrariesAccess().getClassOfServicesAssignment_11(), "rule__UserLibraries__ClassOfServicesAssignment_11");
					put(grammarAccess.getUserLibrariesAccess().getServicesAssignment_14(), "rule__UserLibraries__ServicesAssignment_14");
					put(grammarAccess.getUserLibrariesAccess().getGovernanceStrategiesAssignment_17(), "rule__UserLibraries__GovernanceStrategiesAssignment_17");
					...
					put(grammarAccess.getExperimentVariableAccess().getNameAssignment_1(), "rule__ExperimentVariable__NameAssignment_1");
					put(grammarAccess.getExperimentVariableAccess().getTypeIntegerAssignment_3_0_0(), "rule__ExperimentVariable__TypeIntegerAssignment_3_0_0");
					put(grammarAccess.getExperimentVariableAccess().getIntValueAssignment_3_0_1(), "rule__ExperimentVariable__IntValueAssignment_3_0_1");
					put(grammarAccess.getExperimentVariableAccess().getTypeDoubleAssignment_3_1_0(), "rule__ExperimentVariable__TypeDoubleAssignment_3_1_0");
					put(grammarAccess.getExperimentVariableAccess().getDoubleValueAssignment_3_1_1(), "rule__ExperimentVariable__DoubleValueAssignment_3_1_1");
					put(grammarAccess.getExperimentVariableAccess().getTypeStringAssignment_3_2_0(), "rule__ExperimentVariable__TypeStringAssignment_3_2_0");
					put(grammarAccess.getExperimentVariableAccess().getStringValueAssignment_3_2_1(), "rule__ExperimentVariable__StringValueAssignment_3_2_1");
					put(grammarAccess.getExperimentVariableAccess().getTypeDistributionAssignment_3_3_0(), "rule__ExperimentVariable__TypeDistributionAssignment_3_3_0");
					put(grammarAccess.getExperimentVariableAccess().getDistrbutionAssignment_3_3_1(), "rule__ExperimentVariable__DistrbutionAssignment_3_3_1");
					put(grammarAccess.getExperimentVariableAccess().getTypeStrategyAssignment_3_4_0(), "rule__ExperimentVariable__TypeStrategyAssignment_3_4_0");
					put(grammarAccess.getExperimentVariableAccess().getStrategyAssignment_3_4_1(), "rule__ExperimentVariable__StrategyAssignment_3_4_1");
					...
					put(grammarAccess.getGovernanceStrategyAccess().getPullStrategyAssignment_3_0_2(), "rule__GovernanceStrategy__PullStrategyAssignment_3_0_2");
					put(grammarAccess.getGovernanceStrategyAccess().getPushAssignment_3_1_0(), "rule__GovernanceStrategy__PushAssignment_3_1_0");
					put(grammarAccess.getGovernanceStrategyAccess().getPushStrategyAssignment_3_1_2(), "rule__GovernanceStrategy__PushStrategyAssignment_3_1_2");
					put(grammarAccess.getGovernanceStrategyAccess().getCnpAssignment_3_2_0(), "rule__GovernanceStrategy__CnpAssignment_3_2_0");
					put(grammarAccess.getGovernanceStrategyAccess().getContractNetProtocalAssignment_3_2_2(), "rule__GovernanceStrategy__ContractNetProtocalAssignment_3_2_2");
					put(grammarAccess.getContractNetProtocolAccess().getDescriptionAssignment_0_1(), "rule__ContractNetProtocol__DescriptionAssignment_0_1");
					put(grammarAccess.getContractNetProtocolAccess().getVariablesAssignment_1(), "rule__ContractNetProtocol__VariablesAssignment_1");
					put(grammarAccess.getContractNetProtocolAccess().getRoleBehaviorsAssignment_4(), "rule__ContractNetProtocol__RoleBehaviorsAssignment_4");
					put(grammarAccess.getContractNetProtocolAccess().getProcessesAssignment_8(), "rule__ContractNetProtocol__ProcessesAssignment_8");
					...
					put(grammarAccess.getProcessModelAccess().getActionsAssignment_4(), "rule__ProcessModel__ActionsAssignment_4");
					put(grammarAccess.getProcessModelAccess().getStatesAssignment_6(), "rule__ProcessModel__StatesAssignment_6");
					put(grammarAccess.getPullStrategyAccess().getDescriptionAssignment_0_1(), "rule__PullStrategy__DescriptionAssignment_0_1");
					put(grammarAccess.getPullStrategyAccess().getMechanismsAssignment_3(), "rule__PullStrategy__MechanismsAssignment_3");
					put(grammarAccess.getPullStrategyAccess().getProcessesAssignment_7(), "rule__PullStrategy__ProcessesAssignment_7");
					put(grammarAccess.getPushStrategyAccess().getDescriptionAssignment_0_1(), "rule__PushStrategy__DescriptionAssignment_0_1");
					put(grammarAccess.getPushStrategyAccess().getMechanismsAssignment_3(), "rule__PushStrategy__MechanismsAssignment_3");
					put(grammarAccess.getPushStrategyAccess().getProcessesAssignment_7(), "rule__PushStrategy__ProcessesAssignment_7");
					...
					put(grammarAccess.getMechanismAccess().getDescriptionAssignment_4_1(), "rule__Mechanism__DescriptionAssignment_4_1");
					put(grammarAccess.getMechanismAccess().getAttributesAssignment_5_2(), "rule__Mechanism__AttributesAssignment_5_2");
					...
					put(grammarAccess.getWorkItemAccess().getTypeAssignment_1_1(), "rule__WorkItem__TypeAssignment_1_1");
					...
					put(grammarAccess.getWorkItemAccess().getRequiredAnalysisAssignment_5_1_0_2(), "rule__WorkItem__RequiredAnalysisAssignment_5_1_0_2");
					put(grammarAccess.getWorkItemAccess().getRequiredAnalysisAssignment_5_1_0_3_1(), "rule__WorkItem__RequiredAnalysisAssignment_5_1_0_3_1");
					put(grammarAccess.getWorkItemAccess().getRequiredServicesAssignment_5_1_3(), "rule__WorkItem__RequiredServicesAssignment_5_1_3");
					put(grammarAccess.getWorkItemAccess().getRequiredServicesAssignment_5_1_4_1(), "rule__WorkItem__RequiredServicesAssignment_5_1_4_1");
					...
					put(grammarAccess.getWorkItemAccess().getClassOfServiceAssignment_11_1(), "rule__WorkItem__ClassOfServiceAssignment_11_1");
					put(grammarAccess.getWorkItemAccess().getWorkSourceAssignment_12_1(), "rule__WorkItem__WorkSourceAssignment_12_1");
					put(grammarAccess.getWorkItemAccess().getArrivalTimeAssignment_13_1(), "rule__WorkItem__ArrivalTimeAssignment_13_1");
					put(grammarAccess.getWorkItemAccess().getDueDateAssignment_14_1(), "rule__WorkItem__DueDateAssignment_14_1");
					put(grammarAccess.getWorkItemAccess().getIdAssignment_16(), "rule__WorkItem__IdAssignment_16");
					...
					put(grammarAccess.getWorkItemTypeAccess().getNameAssignment_1(), "rule__WorkItemType__NameAssignment_1");
					put(grammarAccess.getWorkItemTypeAccess().getDescriptionAssignment_3_1(), "rule__WorkItemType__DescriptionAssignment_3_1");
					put(grammarAccess.getWorkItemTypeAccess().getHierarchyAssignment_4_2(), "rule__WorkItemType__HierarchyAssignment_4_2");
					...
					put(grammarAccess.getServiceProviderAccess().getTypeAssignment_1_1(), "rule__ServiceProvider__TypeAssignment_1_1");
					...
					put(grammarAccess.getServiceProviderAccess().getGovernanceStrategyAssignment_5_1(), "rule__ServiceProvider__GovernanceStrategyAssignment_5_1");
